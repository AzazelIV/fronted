  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="25px" style={{ textAlign: 'center' }}>
        {tokenMode
          ? TranslateString(10002, 'Stake tokens to earn VLTR')
          : TranslateString(320, 'Stake LP tokens to earn VLTR')}
      </Heading>
      <Heading as="h2" color="secondary" mb="12px" style={{ textAlign: 'center' }}>
        REMEMBER $VLT/$VLTR Token has a 10% transaction fee that affects both deposits and withdrawals
      </Heading>
      
      <Heading as="h4" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        All deposit fees will be used towards the Faction Battle prize.
      </Heading>
